...
def main():
    ...
    if args.optimised:
        if args.lumped:
            print(args.mesh_file_name, 'EulerCromerOptimisedLumped')
        elif args.lumped2:
            print(args.mesh_file_name, 'EulerCromerOptimisedLumped2')
        else:
    ...
    networks = {'1650beam192.msh': 'Network1650beam192.vtk',
                '1650beam288.msh': 'Network1650beam288.vtk',
                '1650beam384.msh': 'Network1650beam384.vtk',
                '1650beam480.msh': 'Network1650beam480.vtk',
                '1650beam672.msh': 'Network1650beam672.vtk',
                '1650beam864.msh': 'Network1650beam864.vtk',
                '1650beam1248.msh': 'Network1650beam1248.vtk',
    ...
    dxs = {'1650beam192.msh': 0.100,
           '1650beam288.msh': 0.100,
           '1650beam384.msh': 0.100,
           '1650beam480.msh': 0.100,
           '1650beam672.msh': 0.100,
           '1650beam864.msh': 0.0750,
           '1650beam1248.msh': 0.0700,
    ...
    damage_sum_data, tip_displacement_data, tip_force_data = model.simulate(model, sample=1, steps=1000, integrator=integrator, write=1000, toolbar=0)
