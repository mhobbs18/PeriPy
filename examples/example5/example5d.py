...
# =============================================================================
#     saf_fac = 0.05 # Typical values 0.70 to 0.95 (Sandia PeridynamicSoftwareRoadmap) 0.5
#     model.dt = (
...
# =============================================================================
    ...
    damage_sum_data, tip_displacement_data, tip_shear_force_data = model.simulate(model, sample=1, steps=1, integrator=integrator, write=1, toolbar=0)
    plt.figure(1)
    ...
    plt.plot(np.array(tip_shear_force_data)/2400)
    plt.show()
