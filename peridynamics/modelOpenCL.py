...
class Model:
    ...
    def __init__(self, dimensions=3, initial_crack = [], tip = [], rebar, bond_type):
        ...
        # Is the problem a plain concrete problem or a concrete + steel rebar? Default is 0 (steel rebar)
        self.plain = 1
...
# =============================================================================
        ...
        if self.mesh_file in self.benchmark_problems:
            ...
            self.PD_DAMPING = 2.5e2                           # damping term
